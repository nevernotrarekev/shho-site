...
<p class="contain"><input type="text" name="author" id="author" placeholder="enter your name" value="<?php echo $comment_author; ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
<label for="author">Name <?php if ($req) echo "(required)"; ?></label></p>

<p class="contain"><input type="email" name="email" id="email" placeholder="enter your email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
<label for="email">Mail <?php if ($req) echo "(required)"; ?></label></p>

<p class="contain"><input type="url" name="url" id="url" placeholder="enter your website" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
